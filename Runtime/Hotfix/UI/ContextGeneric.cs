...
{
    public class Context<TView, TViewModel> where TView : IView where TViewModel : IViewModel
    {
        ...
        internal Context(TView view, TViewModel viewModel, IResourceLoader loader, ViewConfig config)
        {
            ViewModel = viewModel;
            View = view;
